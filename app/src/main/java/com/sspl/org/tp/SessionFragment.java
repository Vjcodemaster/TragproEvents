...
public class SessionFragment extends Fragment {
    ...
    public SessionsRVAdapter sessionsRVAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sessionsRVAdapter = new SessionsRVAdapter(getActivity(), 3, getActivity().getSupportFragmentManager(), mListener);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mListener.onFragmentMessage("SessionsFragment", getString(R.string.app_name), false);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_sessions);
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(getActivity());
        mLinearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(mLinearLayoutManager);
        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(sessionsRVAdapter);
